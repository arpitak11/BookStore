...
function Signup() {
  ...
  const onSubmit = async(data) => {
    ...
    .then((res)=>{
      ...
      //local storage mei sirf id,name,email wagera chahiye
  ...
  <div className="modal-box">
    ...
    <div className='flex justify-around mt-4'>
        <button className='bg-pink-500 text-white wounded-md px-3 py-1 hover:bg-pink-800 duration-200'>Sign up</button>
